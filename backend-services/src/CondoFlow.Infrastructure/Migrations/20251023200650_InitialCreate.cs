    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("87654321-4321-4321-4321-210987654321"), "Mantenimiento Diciembre 2024", new DateTime(2024, 12, 1, 0, 0, 0, 0, DateTimeKind.Utc), new DateTime(2024, 12, 31, 0, 0, 0, 0, DateTimeKind.Unspecified), 12, new Guid("12345678-1234-1234-1234-123456789012"), "Pending", null, 2024, 1800.00m, "DOP" });

            migrationBuilder.InsertData(
                table: "Apartments",
                columns: new[] { "Id", "BlockId", "Floor", "IsActive", "Number" },
                values: new object[,]
                {
                    { 1, 1, 1, true, "101" },
                    { 2, 1, 1, true, "102" },
